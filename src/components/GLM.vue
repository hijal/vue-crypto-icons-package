<template>
  ...
  >
    <path
      :fill="color"
      d="M708.7,0C317.9,0,0,317.9,0,708.7s317.9,708.7,708.7,708.7s708.7-317.9,708.7-708.7S1099.4,0,708.7,0z
	...
	c0-47.5,38.6-86.1,86.1-86.1s86.1,38.6,86.1,86.1C792.8,624.6,754.2,663.2,706.7,663.2z"
    />
  </svg>
</template>
