<template>
  ...
  >
    ...
    />
    <circle cx="29.24" cy="60.9" r="2.5" :fill="color" />
    <path
      :fill="color"
      d="M76 69.46a2.25 2.25 0 0 0-2.25-2.25H22.08a2.25 2.25 0 0 0 0 4.5h51.65A2.25 2.25 0 0 0 76 69.46Z"
    />
    <circle cx="14.37" cy="69.46" r="2.5" :fill="color" />
    <path
      d="M36.43 75.88a2.25 2.25 0 0 0 0 4.5h62.65a2.25 2.25 0 0 0 0-4.5Z"
      :fill="color"
    />
    <circle cx="28.28" cy="77.96" r="2.5" :fill="color" />
    <path
      d="M51.77 86.57a2.25 2.25 0 0 0-2.25-2.25H25.64a2.25 2.25 0 0 0 0 4.5h23.88a2.25 2.25 0 0 0 2.25-2.25Z"
      :fill="color"
    />
    <circle cx="18.11" cy="86.57" r="2.5" :fill="color" />
    <path
      ...
      :fill="color"
    />
    <circle cx="61.13" cy="95.34" r="2.5" :fill="color" />
    <path
      d="M79.93 101.5H49.05a2.25 2.25 0 0 0 0 4.5h30.88a2.25 2.25 0 0 0 0-4.5Z"
      :fill="color"
    />
    <circle cx="41.76" cy="103.75" r="2.5" :fill="color" />
  </svg>
</template>
