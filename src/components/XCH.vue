<template>
  <svg
    ...
    style="enable-background: new 0 0 99.7 37.8"
    xml:space="preserve"
    :width="size"
    :height="size"
  >
    <path :fill="color" d="M59.9,12.3h8.7v25.1h-8.7V12.3z" />
    <path
      :fill="color"
      d="M48,10.4c-3.3,0-6.7,0.8-7.6,2.3c0,0,0,0,0,0.1V2.2h-8.9v16.7v0c0.9,0.4,1.8,0.9,2.7,1.4
    ...
    <path
      :fill="color"
      d="M64.1,0c-2.7,0-4.6,1.9-4.6,4.6c0,2.7,1.9,4.6,4.6,4.6c2.7,0,4.6-1.9,4.6-4.6C68.7,1.9,66.8,0,64.1,0z"
    />
    <path
      :fill="color"
      d="M98.2,22.8L98.2,22.8l0-11.2h-8.9l0,1.6c-8.6-5.5-14.1,0.2-14.1,0.2c-2.6,2.4-4.1,6.1-4.1,10.9
